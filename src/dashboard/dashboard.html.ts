...
(function () {
  ...
  const REASON_TEXT = {
    en: {
      ...
      OPEN_DRAFT_PRS: function (p) { return p.count + ' draft PR(s) referencing this issue (weaker signal - may be abandoned)'; },
    ...
    es: {
      ...
      OPEN_DRAFT_PRS: function (p) { return p.count + ' PR(s) en borrador referencian este issue (señal más débil - puede estar abandonado)'; },
